...
function Banner({ pageTitle }: { pageTitle: string }) {
  return (
    <div className="bg-center bg-cover bg-[url('/images/general/banner/background.jpg')] bg-opacity-10 h-[200px] flex flex-row justify-stretch items-end">
      <div className="flex justify-between bg-white items-center py-1 w-full mx-80 px-4 -mb-6 rounded shadow">
